...
def fetch_url(url, referer = None, retries = 1, dimension = False,useragent=False):
    ...
    url = add_get_args_to_url(url,{'rand':r})
...
#             print content
#             print url,open_req.code,open_req.headers
...
class Scraper:
    ...
    def link_data(self):
        ...
        if self.soup:
            ...
            if og_title and og_title.get('content',None):
                link_data['title'] = og_title['content']
...
class EmbedlyOEmbed(OEmbed):
    ...
    """
    domains = [
#                '23hq.com', '5min.com', '99dollarmusicvideos.com',
...
#         'zero-inch.com'
    ...
    api_params = {'format':'json', 'maxwidth':600, 'key' : "558cdd864a89498ca58ef7258241298c" }
...
class Link(object):
    ...
    def __init__(self,link,image,embed,header,data):
        self.link = link
        self.image = image
        self.embed = embed
        self.header = header
